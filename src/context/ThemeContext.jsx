...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      "--primary-gradient",
      `linear-gradient(135deg, ${primaryColor}, ${darkerShade})`,
    );
  ...
  const hoverContrast = getContrastColor(adjustColor(color, -10));
  
  styleTag.innerHTML = `
    /* Dynamic Theme Classes */
    .bg-primary-custom { background-color: ${color} !important; }
    .text-primary-custom { color: ${color} !important; }
    .text-primary-contrast { color: ${contrastText} !important; }

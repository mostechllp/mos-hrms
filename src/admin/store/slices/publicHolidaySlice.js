...
export const fetchPublicHolidays = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      // Fallback: if response is { data: [...] } (without success)
      else if (res.data?.data && Array.isArray(res.data.data)) {
        holidaysData = res.data.data;
      }
      // Fallback: if response is { success: true, data: { data: [...] } }
      ...
      console.log("Extracted holidays data:", holidaysData);
      console.log("Number of holidays:", holidaysData.length);

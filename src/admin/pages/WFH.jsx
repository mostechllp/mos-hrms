  ...
  return (
    <div className="w-full overflow-x-hidden">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-3 md:p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex justify-between items-start mb-1 md:mb-2">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center">
                <i className="fas fa-home text-green-600 dark:text-green-400 text-sm md:text-lg"></i>
              </div>
            </div>
                ...
                {currentRequests.length > 0 ? (
                  currentRequests.map((request, idx) => (
                    ...
                    >
                      ...
                      <td
                        className="px-3 md:px-4 py-2 md:py-3 text-xs md:text-sm text-gray-400 dark:text-gray-500 max-w-[150px] truncate"
                        title={request.notes}
                      >
                        {request.notes || "-"}
                      </td>
                          ...
                          {request.status?.toLowerCase() === "pending" && (
                            <>
                              <button
                                ...
                                className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-green-500 dark:text-green-400 transition-colors"
                                title="Approve"
                              >
      ...
      {showDetailsModal && selectedRequest && (
        <div
          className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm z-[1100] flex items-center justify-center p-4"
          onClick={() => setShowDetailsModal(false)}
        >
          <div
            className="bg-white dark:bg-gray-800 max-w-md w-full rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700"
          ...
          >
            ...
            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              <button
                onClick={() => setShowDetailsModal(false)}
                className="px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all"
              >
                Close
              </button>
              {selectedRequest.status?.toLowerCase() === "pending" && (
                <>
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-green-500 text-white hover:bg-green-600 dark:hover:bg-green-700 transition-all"
                  >
                    Approve
                  </button>
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-red-500 text-white hover:bg-red-600 dark:hover:bg-red-700 transition-all"
                  >
                    Reject
                  </button>
                </>

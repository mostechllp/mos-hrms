  ...
  useEffect(() => {
    if (organizations && organizations.length > 0 && id && !initialized) {
      ...
      if (organization) {
        ...
        const multiCompany = rawOrg.multi_company || rawOrg.has_multiple_companies;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (updateOrganization.fulfilled.match(result)) {
        ...
        const errorMsg = result.payload?.message || result.payload || "Failed to update organization";
    ...
    <div className="w-full overflow-x-hidden">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-xs md:text-sm mb-4 md:mb-6 flex-wrap">
          ...
          <span className="text-gray-500 dark:text-gray-400">Edit Organization</span>
        </div>

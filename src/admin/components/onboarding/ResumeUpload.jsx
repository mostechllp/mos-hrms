...
const ResumeUpload = () => {
  ...
  const { isLoading, error, resumeData } = useSelector(
    ...
    <div className="mb-8 p-5 bg-amber-50 dark:bg-amber-950/20 border border-amber-200/50 dark:border-amber-900/40 rounded-2xl flex gap-4 text-left animate-fadeIn">
      ...
      <div>
        ...
        <p className="text-xs text-amber-700 dark:text-amber-400 mt-1 leading-relaxed">
          Please add <strong>VITE_OPENROUTER_API_KEY</strong> to your{" "}
          <code>.env</code> file in the project root to enable automated resume
          parsing.
        </p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-soft border border-gray-100 dark:border-gray-700 p-8 md:p-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Our AI will automatically extract details for you.
          </p>
        </div>
          ...
          <>
            <div
              ...
              className={`relative border-2 border-dashed rounded-3xl p-12 transition-all duration-300 flex flex-col items-center justify-center cursor-pointer group ${
                isDragging
                  ? "border-green-500 bg-green-50/60 dark:bg-green-950/15"
            ...
            >
              ...
              <div
                className={`w-20 h-20 rounded-2xl flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 pointer-events-none ${
                  isDragging
              ...
              <div className="text-center pointer-events-none">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                  Supported formats:{" "}
                  <span className="font-medium text-gray-700 dark:text-gray-300 underline underline-offset-4 decoration-green-500/30">
                    PDF, DOCX
                  </span>
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <div className="w-full max-w-xs bg-gray-100 dark:bg-gray-700 rounded-full h-1.5 mt-8 overflow-hidden">
              <div
                ...
                style={{
                  width: `${uploadProgress < 100 ? uploadProgress : 95}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <div className="p-4 bg-green-50 dark:bg-green-950/15 rounded-2xl border border-green-100/50 dark:border-green-900/30 text-center max-w-sm mb-6">
              <p className="text-sm text-green-800 dark:text-green-300">
                We&apos;ve extracted all information. You can now review and
                edit the details in the next step.
              </p>
            </div>

            <button
              onClick={() => dispatch(resetOnboarding())}
              className="flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors border border-green-200/50 dark:border-green-800/50 shadow-sm"
            >
              <FiRefreshCw size={16} />
